...
#### Project Goals
Rimworld is a game that has a massive mod (user modifications) community where the vast majority of players tend to run their games with an average of 50 - 200 mods. These are, for the most part, supplied for free Valve's gaming app, [Steam.](https://steamcommunity.com/app/294100/workshop/)

The main problem faced by members of the Rimworld community though is the browsing capacity of Steam is quite limited with options being 'Most Popular', 'Most Subscribed' and 'Most Recent'. Outside of those ranges your search is limited to direct name search and a tag system but both are found with inaccurate, questionable results. 

Rimworld Mod Locker aims ot solve this problem by supplying the very sought after ability to browse mods by what category they fall under. This is a extremely common question sought after among community social media groups e.g. "I'm looking for new races to add to the game. Anyone have a list of good mods to add?"
 
#### Developer Goals
The developer's goal was to make a data-centric wesbite that showed off a range of HTML, CSS, Javascript, Python and an understanding of how databases work.

The developer is also a frequesnt player of the game Rimworld and a major user of mods for the game. This project is to be a way of saying thank you to the community who spend so much time and effort to create these mods for free. The fact that content can be generated by other users too means the develoepr themselves could also use the site to discover new and exciting mods.
